# Ratchanon Noknoy
**Software Engineer | Healthcare IT & Digital Transformation Specialist**

Professional Software Engineer with a strong focus on building secure, scalable, and user-centric healthcare solutions. Expert in Next.js and HOSxP system integration, dedicated to bridging the gap between complex medical data and seamless user experience.
...
**Kamphaeng Phet Municipal Community Hospital** | *Mar – Sep 2025*
* **Hospital Ecosystem:** Developed the official hospital website as a central hub for medical information and online services.
* **Secure Integration:** Engineered secure SQL protocols for HOSxP data integration, ensuring strict Data Privacy and integrity.
* **Process Automation:** Streamlined administrative workflows and patient notifications via LINE Messaging API.
* **Digital Transformation:** Built a high-performance patient registration platform using Next.js 14.

#### Programmer Intern
**Kosamphi Nakhon Hospital** | *May – Sep 2024*
* **Transparency Systems:** Developed the ITA Website to enhance institutional transparency.
* **Automation:** Implemented real-time booking alerts using LINE Notify and PHP.
...
| :--- | :--- | :--- | :--- |
| **Patient Registration** | Next.js, SQL, Tailwind | Reduces on-site waiting time with secure data entry. | [View Project](https://kppmch-register.vercel.app/PatientRegister) |
| **Maternal Care System** | LINE API, Apps Script | Provides automated health tracking for expectant mothers. | [View Project](https://kppmch-pregnant.vercel.app/) |
| **Hospital Service Hub** | Next.js, Vercel | Seamless access to hospital services with Responsive UI. | [View Project](https://kppmch-service.vercel.app/) |
...
<div align="center">
  Designed with a focus on <b>Security, Scalability, and Privacy.</b><br>
  Copyright 2025 Ratchanon Noknoy
</div>
